    ...
    <div class="flex">
        ...
        <div class="flex-1 p-6 bg-gray-100 min-h-screen">
            ...
            <div class="bg-white p-6 rounded-2xl shadow">
                ...
                <!-- SEARCH + FILTER -->
                <form method="GET" action="{{ route('users.users-list') }}" class="mb-4 flex gap-3">
                    ...
                    <a href="{{ route('users.users-list') }}" class="bg-gray-300 px-4 rounded">Reset</a>
                </form>
                        ...
                        <tbody class="divide-y">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="text-left p-3 text-sm">
                                    <a href="{{ route('admin.users.index', $tenant->id) }}">{{ $user->name }}</a>
                                </td>
