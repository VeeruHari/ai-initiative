        ...
        <div class="flex-1 p-6 bg-gray-100 min-h-screen">
            <div class="bg-white p-6 rounded-2xl shadow">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('users.users-list') . (count(request()->query()) ? '?' . http_build_query(request()->query()) : '') }}"
                ...
                <!-- EDIT FORM -->
                <form method="POST" action="{{ $user ? route('users.update', [$user]) : route('users.store') }}" class="space-y-4">
                    @csrf
